...
public class UpgradeCursedBlade {

	public static void register(CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register(Commands.literal("upgrade_blade").requires(context -> {
			...
			return upgrade(IntegerArgumentType.getInteger(source, "amount"));
		})));
	}

	private static int upgrade(int amount) {
